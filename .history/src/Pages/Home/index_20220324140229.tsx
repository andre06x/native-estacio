      ...
      <ScrollView>
        ...
        <View style={styles.profile}>
          ...
          <View style={styles.profile_container_info}>
            ...
            <Text style={styles.profile_container_info_text}>Estácio</Text>
            <Text style={styles.profile_container_info_text}>Sistemas de informação</Text>
            <Text style={styles.profile_container_info_text}>201908274417</Text>
          </View>
