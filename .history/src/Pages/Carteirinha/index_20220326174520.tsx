  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{flexDirection: "row", justifyContent: "space-between", marginVertical: 32}}>
        ...
        <View>
          <Text style={{fontWeight: "500", marginVertical: 5, fontSize: 12, color: "#B2B2B2"}}
          >CPF</Text>
          <Text style={{fontWeight: "700", color: "#1E1E1E"}}>168.555.807-00</Text>
        </View>

        <View>
          <Text style={{fontWeight: "500", marginVertical: 5, fontSize: 12, color: "#B2B2B2"}}>Nascimento</Text>
          <Text style={{fontWeight: "700", color: "#1E1E1E"}}>26/06/2000</Text>
        </View>
