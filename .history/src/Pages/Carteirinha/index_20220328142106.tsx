...
import { Image, StyleSheet, Text, View, TouchableHighlight, TouchableOpacity, TouchableWithoutFeedbackBase } from 'react-native';
  ...
  if (!fontsLoaded) {
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <TouchableWithoutFeedbackBase style={{ alignItems: "center" }}>
