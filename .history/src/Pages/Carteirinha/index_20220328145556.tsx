...
import { Image, StyleSheet, Text, View, TouchableHighlight, TouchableOpacity, TouchableWithoutFeedback } from 'react-native';
        ...
        <View style={styles.view_profile}>
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 10 }}>
            <View>
              ...
              >
                {
                  `${matricula.substring(0, 4)} ${matricula.substring(4, 7)} ${matricula.substring(8)}`
                }
              </Text>
            </View>
